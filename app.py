...
def calcular_traccion_compresion(datos, subtipo):
    try:
        ...
        if subtipo == 'tension':
            ...
            return f"La tensión es: {tension:.2f} kg/cm². Factor de seguridad: {factor_seguridad:.2f}"
            ...
            return f"La fuerza aplicada es: {fuerza:.2f} kg"
...
def calcular_flexion(datos):
    try:
        ...
        return f"La tensión de flexión máxima es: {tension_flexion:.2f} kg/cm². Factor de seguridad: {factor_seguridad:.2f}"
...
def calcular_torsion(datos):
    try:
        ...
        return f"La tensión de torsión máxima es: {tension_torsion:.2f} kg/cm². Factor de seguridad: {factor_seguridad:.2f}"
...
def calcular():
    try:
        ...
        if not datos.get('fuerza'):
            return jsonify({"resultado": "Error: Se necesita fuerza."}), 400
        ...
        print(f"Tensión de diseño: {tension_diseno} kg/cm²")
        ...
        if tipo_calculo == 'traccion_compresion':
            ...
            subtipo_corte = datos.pop('subtipo_corte', None)  # Obtener el subtipo de corte
